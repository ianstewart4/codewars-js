...
function goodVsEvil(good, evil) {
    console.log(`Evil: ${evil} Good: ${good}`)
    ...
    let goodCount = 0
    good.split(' ').forEach((x, i) => goodCount += x * goodValues[i])
    let evilCount = 0
    evil.split(' ').forEach((x, i) => evilCount += x * evilValues[i])
...
// Best
// Impressively concise while still being clear enough. 
