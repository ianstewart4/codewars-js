...
function uefaEuro2016(teams, scores) {
    return scores[0] == scores[1] ? `At match ${teams.join(' - ')}, teams played draw.` : `At match ${teams.join(' - ')}, ${teams[scores.indexOf(Math.max(...scores))]} won!`
}

// Best
// A bit more self explanatory and easier to read
